...
const STRIPE_CONFIG = {
  publishableKey:
    window.ENV_CONFIG?.STRIPE_PUBLISHABLE_KEY ||
    "pk_test_51Oa95nGV0Sxov0osSOAojBXG8twhkGR3uMOMjeBqLylrhreSjxC3gkfCP0zo28VqQtks0iqWxKpgqPzVHHVNMC4l00ANjEsIZC", // Fallback as a backup
  // Price IDs for each plan
  priceIds: {
    bronze: "price_1T4a60GV0Sxov0oskmi3quiZ", // $5.99/month
    silver: "price_1T4a5xGV0Sxov0osI1jAZtLD", // $9.99/month
    gold: "price_1T4a5rGV0Sxov0osBdwJ8Tx6", // $29.99/month
    diamond: "price_1T4a5yGV0Sxov0os3PbVOGrH", // $49.99/month
  },
    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (contentType && contentType.indexOf("application/json") !== -1) {
          ...
          errorMessage =
            "O servidor backend de API não está rodando. Feche seu hospedeiro estático atual e inicialize o projeto executando o comando 'npm run dev' no terminal.";
        }
...
const StripeMock = {
  ...
  completeMockSubscription: async function (planType) {
    ...
    StripeIntegration.showNotification(
      `${PLAN_DETAILS[planType].name} subscription activated!`,
      "success",
    );
  ...
  openCustomerPortal: async function () {
    ...
    const planDetails = PLAN_DETAILS[userData.plan] || {
      name: "Paid",
      price: 0,
    };
